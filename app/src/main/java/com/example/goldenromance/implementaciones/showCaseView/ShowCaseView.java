package com.example.goldenromance.implementaciones.showCaseView;
...
import com.example.goldenromance.implementaciones.showCaseView.position.Position;
...
import com.example.goldenromance.implementaciones.showCaseView.radius.ViewRadius;
import com.example.goldenromance.implementaciones.showCaseView.util.ActivityUtils;
import com.example.goldenromance.implementaciones.showCaseView.util.MeasuredUtils;
...
public class ShowCaseView extends FrameLayout {
    ...
    private void configureCard(ViewGroup card) {
        ...
        cardContent.setLayoutParams(new LayoutParams(
        ...
        LayoutParams cardLayoutParams = generateDefaultLayoutParams();
