package com.example.goldenromance.implementaciones.BottonNavigationViewEx;
...
public class BottomNavigationViewInner extends BottomNavigationView {
    ...
    public BottomNavigationViewInner(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TintTypedArray a = ThemeEnforcement.obtainTintedStyledAttributes(context, attrs,
                ...
                new int[]{com.google.android.material.R.styleable.BottomNavigationView_itemHorizontalTranslationEnabled});
        // clear if you don't have set item icon tint list
        if (!a.hasValue(com.google.android.material.R.styleable.NavigationBarView_itemPaddingBottom)) {
            clearIconTintColor();
        }
        a.recycle();
    }
